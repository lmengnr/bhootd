...
int main(int argc, char **argv) {
  ...
  desc.add_options()("help", "Print help messages")("skip", "Show stats")(
  ...
  // if see-stat option is provided then simply display stats on the terminal
  ...
  // If there was no address then exit with error
  if (!addr_provided) {
    std::cerr << "No address provided" << std::endl << desc << std::endl;
    return 1;
  }
